...
public class BlockShapes {
    ...
    public static class ShapeSet {
        ...
        ArrayList<Shape> shapeTypes = new ArrayList<>(List.of(
                ...
                new Shape(List.of(new Cell(0,0), new Cell(1,0),new Cell(1,1),new Cell(1,2),new Cell(2,0))),
                new Shape(List.of(new Cell(0, 0), new Cell(1, 0), new Cell(1, 1), new Cell(0, 1))),
                ...
                new Shape(List.of(new Cell(0, 1), new Cell(1, 1), new Cell(1, 0), new Cell(2, 1))),
                new Shape(List.of(new Cell(0, 1), new Cell(1, 1), new Cell(1, 0), new Cell(2, 1))),
